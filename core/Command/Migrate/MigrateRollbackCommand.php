...
#[Command]
class MigrateRollbackCommand extends MigrationsBaseCommand
{
    use ConfirmableTrait;

    protected ?string $name = BaseCommand::PREFIX_NAME . ':migrate-rollback';

    protected string $description = '运行模块的迁移回滚类';
